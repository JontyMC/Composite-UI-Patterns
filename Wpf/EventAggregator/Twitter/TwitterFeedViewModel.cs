...
namespace EventAggregator.Twitter {
    public class TwitterFeedViewModel : Screen {
        ...
        public TwitterFeedViewModel(IEventAggregator eventAggregator) {
        ...
        public TweetViewModel SelectedTweet
        {
            ...
            set
            {
                ...
                eventAggregator.Publish(new SelectedTweetChanged(selectedTweet));
            }
        }
